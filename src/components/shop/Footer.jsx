            ...
            <ul className="space-y-3 text-sm">
              {s.contact_phone && (
                <li className="flex items-start gap-2">
                  ...
                  <span className="min-w-0 break-words">{s.contact_phone}</span>
                </li>
              )}
              {s.contact_email && (
                <li className="flex items-start gap-2">
                  ...
                  <a href={`mailto:${s.contact_email}`} className="hover:text-white transition-colors break-all min-w-0">{s.contact_email}</a>
                </li>
              )}
              {s.contact_address && (
                <li className="flex items-start gap-2">
                  ...
                  <span className="min-w-0 break-words">{s.contact_address}</span>
                </li>
              )}
