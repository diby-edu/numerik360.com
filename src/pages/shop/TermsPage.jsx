    ...
    <div className="min-h-screen bg-theme-bg">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8 prose prose-gray max-w-none">
          ...
          <p>Le site <strong>Numerik360</strong> (ci-après « la Boutique ») est édité et exploité par Numerik360. Pour toute question, écrivez-nous à <a href="mailto:support@numerik360.com" className="text-primary hover:underline">support@numerik360.com</a> ou via notre <Link to="/contact" className="text-primary hover:underline">page de contact</Link>.</p>

          <h2>2. Objet</h2>
          <p>Les présentes conditions générales régissent les ventes de produits et services effectuées sur la Boutique. Toute commande passée implique l'acceptation pleine et entière de ces conditions.</p>
