      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="space-y-3 mb-6">
          {items.map(({ product, quantity, variant }) => {
            ...
            return (
              <div key={`${product.id}-${variantId ?? 'base'}`} className="bg-white rounded-xl border border-gray-200 p-4 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-primary font-bold text-sm mt-0.5">{formatPrice(unitPrice)}</p>
                </div>
