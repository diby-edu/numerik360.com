                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-1 mt-1">
                            ...
                            <button
                              ...
                              className="w-6 h-6 rounded border border-gray-200 text-gray-400 hover:bg-red-50 hover:text-red-600 hover:border-red-200 flex items-center justify-center ml-1 transition-colors"
                            >
